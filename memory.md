...
**Next step:** Founder: in App Store Connect, pick build 1.3 (8) for the Mac app and 1.3 (7) for Capture, paste the What's New text from `docs/release/1.3-whats-new.md`, upload the Mac screenshots in `Screenshots/AppStore-Mac-2026-09-26/`, and submit both for review.
