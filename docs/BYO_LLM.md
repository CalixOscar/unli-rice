...
**Status:** design, not a work order. Phase 1 is buildable as specced; Phase 2 needs an
entitlement decision that touches App Store review.
...
**Phase 1 — on demand (buildable now).**
